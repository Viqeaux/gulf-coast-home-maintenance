...
Current version **v1.22.0**. Everything below is live unless marked otherwise.
...
**The site is four pages now, and two of them are hand-written.**

| Page | What it is for | Written how |
|---|---|---|
| `/` | Say what this is, prove it is Gulf specific, hand over the free calendars | Hand-written `docs/index.html` |
...
**`docs/site.css` is shared by both hand-written pages.** It was an 839 line
